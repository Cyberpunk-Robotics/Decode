...
@Autonomous(name = "AutoFarAlbastru", group = "Auto")
public class AutoFarAlbastru extends OpMode {
    ...
    private final Pose startPose = new Pose(56.40279720279721, 7.798601398601402, Math.toRadians(90));
    private final Pose shootPose = new Pose(60.22937062937063, 18.881118881118887, Math.toRadians(120));
    private final Pose parkPose = new Pose(30.12167832167833, 7.451748251748244, Math.toRadians(90));
        ...
        switch (pathState) {
            case SHOOT_PRELOAD:
                ...
                if (step == 0) { // Initial 3s spin up
                    ...
                    actionTimer.resetTimer();
                    step++;
                } else if (step == 4 && actionTime() > 0.3) { // Shoot time
                    intake.off();
                    indexer.off(); // Pause
                    actionTimer.resetTimer();
                    step++;
